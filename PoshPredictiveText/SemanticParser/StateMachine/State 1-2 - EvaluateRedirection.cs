...
namespace PoshPredictiveText.SemanticParser
{
    ...
    internal partial class StateMachine
    {
        ...
        internal List<SemanticToken> EvaluateRedirection(SemanticToken token)
        {
            ...
            //machineState.ParameterValues = 1;
            //machineState.ParameterSyntaxItem = new SyntaxItem() { ItemType = SyntaxItemType.REDIRECTION, Name="PATH" };
            redirectionToken.SyntaxItem = new SyntaxItem() { ItemType = SyntaxItemType.REDIRECTION, Name="PATH" };
